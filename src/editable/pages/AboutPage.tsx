  ...
  return (
    <EditableSiteShell>
      <main className="bg-[#FFF6DE] text-[#2f1d16]">
        <section className="border-b border-black bg-[#F48F68] text-[#2f1d16]">
          <div className="mx-auto max-w-[var(--editable-container)] px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
            ...
            <h1 className="editorial-brand mt-5 max-w-3xl text-4xl font-black leading-[1.02] sm:text-6xl">
        ...
        <section className="mx-auto grid max-w-[var(--editable-container)] border-x border-black bg-white lg:grid-cols-[1.45fr_0.55fr]">
          <article className="border-b border-black p-7 sm:p-10 lg:border-b-0 lg:border-r lg:p-16">
            <p className="text-sm font-black uppercase tracking-[0.2em] text-[#F48F68]">About {SITE_CONFIG.name}</p>
          ...
          <aside className="grid bg-[#FFE394]">
            {pagesContent.about.values.map((value, index) => (
              <div key={value.title} className="border-b border-black p-7 last:border-b-0 sm:p-9">
                <p className="text-xs font-black uppercase tracking-[0.2em] text-[#F48F68]">0{index + 1}</p>
        ...
        <section className="border-y border-black bg-[#8BDFDD] text-[#2f1d16]">
          <div className="mx-auto flex max-w-[var(--editable-container)] flex-col gap-6 px-4 py-10 sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
            <h2 className="editorial-brand max-w-2xl text-3xl font-black leading-tight sm:text-4xl">Read the stories shaping the conversation.</h2>
            <Link href="/search" className="inline-flex w-fit bg-[#F48F68] px-6 py-4 text-xs font-black uppercase tracking-[0.18em]">Explore the archive</Link>
          </div>
        </section>
      </main>
    </EditableSiteShell>
