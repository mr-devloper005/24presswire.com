...
const inputClass = 'h-[3.25rem] border border-black bg-white px-4 text-base font-bold text-black outline-none transition placeholder:text-black/35 focus:border-[#F48F68]'
const buttonClass = 'inline-flex h-[3.25rem] items-center justify-center border border-black bg-[#F48F68] px-6 text-xs font-black uppercase tracking-[0.2em] text-[#2f1d16] transition hover:bg-[#8BDFDD] disabled:opacity-60'
